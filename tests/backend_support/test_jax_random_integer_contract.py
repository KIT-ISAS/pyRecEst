...
empty_legacy_keyword_bounds = random.randint(size=(0,), minval=5, maxval=3)
empty_legacy_positional_bounds = random.randint((0,), 5, 3)
...
assert empty_legacy_keyword_bounds.shape == (0,)
assert empty_legacy_positional_bounds.shape == (0,)
