...
class TestMultiSessionAssignment(unittest.TestCase):
    ...
    def _assert_valid_matching(self, selected_mask, left_nodes, right_nodes):
        ...
        self.assertEqual(selected_left_nodes.size, np.unique(selected_left_nodes).size)
        self.assertEqual(selected_right_nodes.size, np.unique(selected_right_nodes).size)
