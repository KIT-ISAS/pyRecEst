from .abstract_custom_lin_bounded_cart_prod_distribution import AbstractCustomLinBoundedCartProdDistribution
from .abstract_hypercylindrical_distribution import AbstractHypercylindricalDistribution

class CustomHypercylindricalDistribution(AbstractCustomLinBoundedCartProdDistribution, AbstractHypercylindricalDistribution):
    def __init__(self, f, bound_dim, lin_dim):
        ...
        AbstractCustomLinBoundedCartProdDistribution.__init__(self, f, bound_dim, lin_dim)
    ...
    def from_distribution(distribution):
        ...
        """
        chhd = CustomHypercylindricalDistribution(distribution.pdf, distribution.lin_dim, distribution.bound_dim)
        return chhd
    ...
    def condition_on_periodic(self, input_periodic, normalize=True):
        ...
        return AbstractHypercylindricalDistribution.condition_on_periodic(self, input_periodic, normalize)

    def condition_on_linear(self, input_lin, normalize=True):
        # Call the condition_on_linear method from the superclass
        return AbstractHypercylindricalDistribution.condition_on_linear(self, input_lin, normalize)
