...
class HypersphericalParticleFilter(AbstractParticleFilter, HypersphericalFilterMixin):
    def __init__(self, n_particles, dim):
        ...
        AbstractParticleFilter.__init__(self, HypersphericalDiracDistribution(tile(eye(dim, 1), (1, n_particles)).T))
    ...
    def get_estimate_mean(self):
        vec_sum = sum(self.filter_state.d * tile(self.filter_state.w, (self.filter_state.input_dim, 1)).T, axis=0)
