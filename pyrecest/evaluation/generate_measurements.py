...
def generate_measurements(groundtruth, simulation_config):
    ...
    if simulation_config.get("eot", False):
        ...
        eot_sample_from = simulation_config["eot_sample_from"]
        assert isinstance(
            shape, Polygon
        ...
        for t in range(simulation_config["n_timesteps"]):
            ...
            if eot_sample_from == "boundary":
                ...
                raise ValueError("eot_sample_from must be either 'vertices' or 'surface'.")
