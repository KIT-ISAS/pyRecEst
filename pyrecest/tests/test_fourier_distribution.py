...
class TestFourierDistribution(unittest.TestCase):
    ...
    def _test_integral_numerical_helper(self, mult_by_n, transformation):
        scale_by = 2 / 5
    ...
    def test_integral_numerical_identity_mult_true(self):
        self._test_integral_numerical_helper(mult_by_n=True, transformation="identity")

    def test_integral_numerical_identity_mult_false(self):
        self._test_integral_numerical_helper(mult_by_n=False, transformation="identity")

    def test_integral_numerical_sqrt_mult_true(self):
        self._test_integral_numerical_helper(mult_by_n=True, transformation="sqrt")

    def test_integral_numerical_sqrt_mult_false(self):
        self._test_integral_numerical_helper(mult_by_n=False, transformation="sqrt")
