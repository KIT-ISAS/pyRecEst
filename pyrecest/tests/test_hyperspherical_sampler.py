...
class TestSymmetricLeopardiSampler(unittest.TestCase):
    def test_mirror_symmetric_sampling(self):
        """
        Check that mirror-symmetric sampling really produces antipodal pairs
        ...
        assert half_set.isdisjoint(neg_half_set)
        assert full_set == half_set | neg_half_set


    def test_plane_symmetric_sampling(self):
        """
        Check that plane-symmetric sampling is symmetric w.r.t. the
