...
class TestAbstractSphereSubsetDistribution(unittest.TestCase):
    ...
    def test_cart_to_sph_to_cart(self, mode):
        ...
        azimuth, theta = AbstractSphereSubsetDistribution.cart_to_sph(x, y, z, mode=mode)
        x_new, y_new, z_new = AbstractSphereSubsetDistribution.sph_to_cart(azimuth, theta)
    ...
    def test_sph_to_cart_to_sph(self, mode):
        ...
        azimuth_new, theta_new = AbstractSphereSubsetDistribution.cart_to_sph(x, y, z, mode=mode)
